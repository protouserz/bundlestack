...
1. Dashboard with store health and revenue overview
2. Create offer — product picker and quantity tiers
3. Active offer on product page (theme widget)
4. Billing page — transparent performance pricing
5. Checkout showing quantity discount applied

## Demo screencast script (~3 min)

1. Install app from dev store (OAuth grant)
2. Dashboard → Create offer → pick product → add tiers → Active → Save
3. Theme editor → add BundleStack block to product template
4. Storefront → product page → click tier → add to cart → checkout shows discount
5. Mention clean uninstall and free-to-start pricing
