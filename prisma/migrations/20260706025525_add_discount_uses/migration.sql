...
INSERT INTO "new_BundleOffer" ("createdAt", "discountIds", "id", "offerType", "productIds", "revenueGenerated", "shop", "status", "tiers", "title", "updatedAt") SELECT "createdAt", "discountIds", "id", "offerType", "productIds", "revenueGenerated", "shop", "status", "tiers", "title", "updatedAt" FROM "BundleOffer";
